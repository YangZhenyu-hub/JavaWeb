...
public abstract class BaseDAO<T> {
    ...
    public BaseDAO(){
        ...
        try {
            ...
            e.printStackTrace();
            throw new BaseDAOException("BaseDAO 构造方法出错，可能的原因是没有指定<>中的类型");
        }
    ...
    protected int executeUpdate(String sql , Object... params) {
        ...
        try{
            ...
            e.printStackTrace();
            throw new BaseDAOException("BaseDAO executeUpdate出错了");
        }
    }
    ...
    protected Object[] executeComplexQuery(String sql , Object... params){
        ...
        try{
            ...
            e.printStackTrace();
            throw new BaseDAOException("BaseDAO executeComplexQuery出错了");
        }
    ...
    protected T load(String sql , Object... params){
        ...
        try{
            ...
            e.printStackTrace();
            throw new BaseDAOException("BaseDAO load出错了");
        }
    ...
    protected List<T> executeQuery(String sql , Object... params){
        ...
        try{
            ...
            e.printStackTrace();
            throw new BaseDAOException("BaseDAO executeQuery出错了");
        }
        return list ;
    }
